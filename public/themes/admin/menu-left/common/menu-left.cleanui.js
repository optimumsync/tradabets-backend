$(function(){
    ...
    $('.cat__menu-left__submenu > a').on('click', function(){
        ...
        if ($('nav').hasClass('cat__config--vertical') || $('body').width() < 768) {
    ...
    $(window).on('resize', function(){
        if ($('nav').hasClass('cat__config--horizontal') || $('body').width() > 768) {
    ...
    if ($('section').hasClass('cat__config--vertical')) {
    ...
    $('.cat__menu-left__action--menu-toggle').on('click', function(){
        if ($('body').width() < 768) {
            $('nav').toggleClass('cat__menu-left--visible--mobile');
        } else {
            $('nav').toggleClass('cat__menu-left--visible');
        }
    })

    $('.cat__menu-left__action--backdrop-toggle').on('click', function(){
        $('nav').removeClass('cat__menu-left--visible--mobile');
    })

...
@section('main-title', 'Bonus Transaction List')
    ...
    <section class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-lg-12 mb-4 date-filter-box">
                ...
                {!! Form::open(['url' => '/bonus-transaction-list','class' => 'form-inline is-dashboard-filter-form mb-2', 'method' => 'get','onsubmit'=>'return validDate()']) !!}
